...
- **Maidenhead grid:** optional overlay from Settings — maximum resolution Off / 4 / 6 / 8; finer detail unlocks by zoom (6-char at 8+, 8-char at 12+). See [maidenhead-grid doc](../../../docs/features/map/maidenhead-grid.md).
